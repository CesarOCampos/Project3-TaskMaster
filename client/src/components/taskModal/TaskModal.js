        ...
        style={{
            ...
            <div className="modal-content">
                <div className="modal-body">
                    <h4>Task Name</h4>
                    <input  className="input-name"  onchange={event => settaskname(event.target.value)}  name="taskname"  placeholder="Task Name"></input>
                    <h4>Task Status</h4>
                    <input className="input-desc" onchange={event => setTaskStatus(event.target.value)} name="taskstatus" placeholder="Task Status"></input>
